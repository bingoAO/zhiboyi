...
package com.bao.meijia.ui.customview;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.rank_list_tab, this, false);
            }
    ...
    private Pair<Float, Float> getIndicatorCoordinates() {
        // default: line below current rank_list_tab
        View currentTab = tabsContainer.getChildAt(currentPosition);
        float lineLeft = currentTab.getLeft();
        float lineRight = currentTab.getRight();

        // if there is an offset, start interpolating left and right coordinates between current and next rank_list_tab
