package com.bao.hnbs.ui.customview.wheelview;
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(context.getResources().getColor(R.color.title_bar_color));
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(context.getResources().getColor(R.color.title_bar_color));
