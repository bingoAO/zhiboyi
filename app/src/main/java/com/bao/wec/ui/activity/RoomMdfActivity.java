...
public class RoomMdfActivity extends BasePageActivity {
    AQuery aq;
    ...
    protected void setLayoutView() {
        setContentView(R.layout.activity_room_mdf);
        aq = new AQuery(this);
    }
    ...
    protected void setListener() {
        aq.id(R.id.room_mdf_avatar_btn).clicked(this,"aq_add_image");
        aq.id(R.id.room_mdf_bottom_btn).clicked(this,"aq_mdf");
    ...
    public void aq_mdf(){
        NoticeDialog.newInstanceShow(this,"修改成功").setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            aq.id(R.id.room_mdf_avatar).image(newAvatar);
            uploadAvatar();
        }
    }
