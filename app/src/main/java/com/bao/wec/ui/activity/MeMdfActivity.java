...
public class MeMdfActivity extends BasePageActivity {
    AQuery aq;

    Bitmap newAvatar;
    Uri imageCaptureUri;

    int curGenderType = Constant.CODE.FEMALE;


    @Override
    protected void setLayoutView() {
        setContentView(R.layout.activity_me_mdf);
        aq = new AQuery(this);
    }
    ...
    protected void setupViews(Bundle bundle) {
        aq.id(R.id.title_bar_name).text("个人资料");
    ...
    protected void setListener() {
        aq.id(R.id.me_mdf_avatar_btn).clicked(this,"aq_add_image");

        aq.id(R.id.me_mdf_male_iv).clicked(this, "aq_male");
        aq.id(R.id.me_mdf_male_label).clicked(this, "aq_male");
        aq.id(R.id.me_mdf_female_iv).clicked(this, "aq_female");
        aq.id(R.id.me_mdf_female_label).clicked(this, "aq_female");
    ...
    public void aq_male() {
        curGenderType = Constant.CODE.MALE;
        aq.id(R.id.me_mdf_male_iv).image(R.drawable.icon_radiobox_selected);
        aq.id(R.id.me_mdf_female_iv).image(R.drawable.icon_radiobox_normal);
    }

    public void aq_female() {
        curGenderType = Constant.CODE.FEMALE;
        aq.id(R.id.me_mdf_female_iv).image(R.drawable.icon_radiobox_selected);
        aq.id(R.id.me_mdf_male_iv).image(R.drawable.icon_radiobox_normal);
    }
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            aq.id(R.id.me_mdf_avatar).image(newAvatar);
            uploadAvatar();
        }
    }
